...
# ===== AUDIT 1: GPU-runtime note added (student erratum (b)) =============================================
...
# ===== AUDIT 3: trainer description updated ==============================================================
...
# ===== AUDIT 4: train_agent: hyperparameter block removed, lr 1e-3 -> 3e-3, defaults 512/8 -> 128/4 ======
...
# ===== AUDIT 6: net1 budget 256 -> 96 steps ==============================================================
...
# ===== AUDIT 7: text 512 -> 192 ==========================================================================
# Matches the net2 budget below.
# ================================================================================================
# ! CELL TYPE: markdown
# ! FILTERS: []
# ! TAGS: []
...
# ===== AUDIT 8: net2 budget 512 -> 192 steps =============================================================
...
# ===== AUDIT 9: bare '#' line removed from the EXERCISE template (P4) ====================================
...
# ===== AUDIT 10: train_agent_multienv: 32 -> 512 envs, hyperparameters removed, lr 3e-3, default 512 -> 192 steps ====
...
# ===== AUDIT 12: net3 budget 4096/128 -> 160/8 ===========================================================
...
# ===== AUDIT 14: leaked bookkeeping comment removed ======================================================
...
# ================================================================================================
# ===== AUDIT 13: bare '#' line removed from the EXERCISE template (P4) ===================================
...
# ===== AUDIT 15: net4 prose: plateau explained, '~5 minute run' claim removed ============================
...
# ===== AUDIT 16: net4 budget 4096/128 -> 192/8 ===========================================================
...
# ===== AUDIT 17: bonus bullet replaced ===================================================================
