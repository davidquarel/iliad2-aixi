...
% Problem 11: explicit expectimax form — offshoot of Problem 2 (Bellman optimality)
\node[right=14mm of 2] (11) {\hyperref[prob:expectimax]{\textbf{11} expectimax}};
...
% Edge: Problem 11 (expectimax form of AIXI) depends on the optimal-policy machinery
\draw[arr] (2) -- (11);
...
\begin{itemize}\itemsep=2pt
    ...
    \item Problem 11 derives the explicit expectimax form of AIXI.
\end{itemize}
...
\begin{align*}
 ...
 \sum_{\aes'_{t+1:m}} \nu^\pi(\aes'_{t+1:m} \mid \aes_{<t}\, \aes'_t) \left[ r'_t + \gamma G_{t:m} \right].
\end{align*}
