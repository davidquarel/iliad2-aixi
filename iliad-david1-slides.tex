...
\begin{itemize}\footnotesize
    ...
    \item Result~3 needs heavier machinery (martingales, change of measure), so probably a stretch goal.
\end{itemize}
\end{frame}
...
% \end{itemize}
\pause
\textbf{Intuition:} \emph{Whenever good behaviour in $\mu$ isachievable, 
